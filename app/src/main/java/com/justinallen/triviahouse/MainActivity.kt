package com.justinallen.triviahouse
...
class MainActivity : AppCompatActivity() {
    ...
    private var locationRef: DatabaseReference = rootRef.child("location")
    private var backPackRef: DatabaseReference = rootRef.child("backpack")
        ...
        lookButton?.setOnClickListener(View.OnClickListener { _ ->
            ...
            if(look?.resultType == BACKPACK){
                if(backPack?.containsValue(look.result!!)!!){
                    ...
                    backPack?.put(backPack?.size.toString(), look.result!!)
